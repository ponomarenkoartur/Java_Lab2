...
public class ListImpl implements List  {
	...
	private final static int EMPTY_ARRAY_SIZE = 0;

	// Properties

	private Object[] array;
	private int count = EMPTY_ARRAY_SIZE;
	...
	private void extendArrayTo(int newSize) {
		if (newSize <= array.length) {
			throw new InvalidParameterException("New size to extend an array can not be less than initial size.");
		}
